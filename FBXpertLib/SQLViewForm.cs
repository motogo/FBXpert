...
namespace FBXpertLib.SQLView
{
    ...
    /// </summary>
    public partial class SQLViewForm2 : INormalForm
    {
        ...
        public SQLViewForm2(DBRegistrationClass ca, Form mdiParent = null, eColorDesigns appDesign = eColorDesigns.Gray, eColorDesigns developDesign = eColorDesigns.Gray, bool testMode = false)
        {
            MdiParent = mdiParent;
            _dbRegOrg = ca;
        ...
        public bool TestOpen(DBRegistrationClass dbReg)
        {
            ...
            */
            ...
            if (lifeTime == "-1")
            {
                hsLifeTime.BackColor = Color.Red;
            }
            return (lifeTime != "-1");
        }
...
CON> WHERE T.MON$ATTACHMENT_ID = CURRENT_CONNECTION;
        */
        ...
        {
            if (SEMessageBox.ShowMDIDialog(this, "DeleteHistory", "DoYouWantDeleteHistory", FormStartPosition.CenterScreen, SEMessageBoxButtons.NoYes, SEMessageBoxIcon.Exclamation) == SEDialogResult.Yes)
            {

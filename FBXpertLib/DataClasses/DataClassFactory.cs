    ...
    public static class DataClassFactory
    {
        ...
        public static Color GetColor(string name, object obj)
        {
            if ((name == StaticVariablesClass.IndicesKeyStr) || (name == StaticVariablesClass.SystemIndicesKeyStr))
            {
                ...
                {
                    ForeColor = fc.IsActive ? AppColors.ActiveHasConstraint : AppColors.InactiveHasConstraint;
                }
                else
                {
                    ForeColor = fc.IsActive ? AppColors.Active : AppColors.Inactive;
                }
                return ForeColor;
            }
            if (name == StaticVariablesClass.ForeignKeyStr)
            {
                ...
                return tc.IsActive ? AppColors.Active : AppColors.Inactive;
            }
            return Color.Black;
        }
